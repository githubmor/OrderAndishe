...
namespace OrdersAndisheh.DevUI.ViewModels
{
    ...
    public partial class KhodroViewModel : SingleObjectViewModel<Khodro, int, IMyContextCFUnitOfWork>
    {
        ...
        /// <summary>
        /// The view model for the KhodroKhodroProductRelation detail collection.
        /// </summary>
        public CollectionViewModel<KhodroProductRelation, int, IMyContextCFUnitOfWork> KhodroKhodroProductRelationDetails
        {
            get { return GetDetailsCollectionViewModel((KhodroViewModel x) => x.KhodroKhodroProductRelationDetails, x => x.KhodroProductRelation, x => x.KhodroId, (x, key) => x.KhodroId = key); }
        }
    }
}
